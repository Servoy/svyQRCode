...
- Understand the dual-layer architecture:
  - Servoy spec file (`svyqrcode/svyqrcode.spec` or `svyqrcodegenerator/svyqrcodegenerator.spec`)
  - Angular implementation (`svyqrcode/projects/svyqrcode/src/scanner/` or `svyqrcode/projects/svyqrcode/src/generator/`)
  - AngularJS scanner implementation (`svyqrcode/svyqrcode/svyqrcode.js`)
...
```bash
git blame -L <start>,<end> "svyqrcode/<file-path>"
```
